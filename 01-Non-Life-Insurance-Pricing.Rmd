...
that, given a set of explanatory variables $\boldsymbol{x}_i=(x_{i1}, x_{i2}, \dots, x_{ip})\in \mathcal{X} \subseteq \mathbb{R}^p$, returns an estimate of the expected value of the response variable $E(Y)$ and possibly estimates of other moments of $Y$ or even the full distribution of $Y$.
```
