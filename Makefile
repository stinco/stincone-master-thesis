pdf:
	...
	rm -f *.log *.mtc* *.maf *.aux *.bcf *.lof *.lot *.out *.toc front-and-back-matter/abbreviations.aux templates/*.log templates/*.mtc* templates/*.maf templates/*.aux templates/*.bcf templates/*.lof templates/*.lot templates/*.out templates/*.toc templates/*.fdb_latexmk templates/*.fls templates/*.synctex.gz templates/*.run.xml
