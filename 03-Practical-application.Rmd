...
As we can see, all the models have positively correlated coefficients. However, the most correlated are the GLM Tot with the GLM AIC and the Elastic Net Tot with the Ridge Tot.
