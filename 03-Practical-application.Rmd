...
```{r, models-results-read, echo = FALSE, cache = FALSE, message = FALSE}
results <- read_csv2(
...
```{r, models-list-render, echo = FALSE, cache = FALSE, message = FALSE}
# Make Table
results %>%
  select(id, model) %>% 
  mutate(
...
```{r, models-results-render, echo = FALSE, cache = FALSE, message = FALSE}
