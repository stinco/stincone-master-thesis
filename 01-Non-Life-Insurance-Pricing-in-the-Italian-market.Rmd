...
Both tariff and offer price must be based not only on technical logics, but also con commercial ones. The commercial logics 
...
Strategia aziendale
- lifetime value: un cliente ti stipula anche altri contratti
- cluster in cui aniamo forti
- marketing: brand awareness, brand image
-->
