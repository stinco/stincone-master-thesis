...
Modeling the large claims in quite difficult in practice becuse usually there is not a lot of observed data on them, so it is hard to understand if they are related to some risk factors (identifiable by the pricing variables) or they happen just by chance.
...
$$
p_Y(y) = P\left( Y = y \right) = {n \choose y} p^y (1-p)^{n-y}, \quad p \in [0, 1]
$$
