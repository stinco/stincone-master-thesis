...
In section \@ref(chap:nlip-details) we defined the compound distribution (definition \@ref(def:comp-dist)) and we reported some results on it. In this section we report the demonstrations of the results \@ref(eq:z) and \@ref(eq:s).
