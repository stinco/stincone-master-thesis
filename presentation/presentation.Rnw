...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Variabili Esplicative e Personalizzazione}
...
\begin{column}{0.5\textwidth}
  \begin{block}{Variabili esplicative}
    ...
    \begin{itemize}
      ...
      \item Informazioni generiche sull'assicurato;
      \item Informazioni assicurative sull'assicurato;
      \item Opzioni della polizza assicurativa;
      \item Informazioni sull'assicurato in quanto cliente;
...
\begin{column}{0.45\linewidth}
  \uncover<1->{
    \begin{block}{Definizione di Premio\vphantom{/}}
      % \vspace{0.2cm}
      % \begin{center}
        \begin{tikzpicture}
...
\begin{column}{0.55\linewidth}
  \uncover<2->{
    \begin{block}{Ottimizzazione del Prezzo\vphantom{/}}
      ...
      \begin{enumerate}
        ...
        \item Aspettativa del Cliente
          \begin{itemize}
            \fontsize{9pt}{11pt}\selectfont
            \item[\faCaretRight] New Business: \textit{Probabilità di Conversion}
            \item[\faCaretRight] Rinnovi: \textit{Probabilità di Retention}
          \end{itemize}
        \item Strategia di Business
          \begin{itemize}
            \fontsize{9pt}{11pt}\selectfont
            \item[\faCaretRight] \textit{Lifetime value}
            \item[\faCaretRight] Profitti/crescita
          \end{itemize}
      \end{enumerate}
...
\begin{column}{0.8\linewidth}
  \begin{block}{Stima di Massima Verosimiglianza con Penalizzazione}
    $$
    \hat{\boldsymbol{\beta}} = \argmin_{\boldsymbol{\beta}\in\mathbb{R}^{p+1}}{\left\{D(\boldsymbol{\beta}, \boldsymbol{y}) + \lambda \sum_{j=1}^p{\beta_j^2} \right\}}
    $$
    con
    \begin{itemize}
...
\begin{column}{0.8\linewidth}
  \begin{block}{Stima di Massima Verosimiglianza con Penalizzazione}
    $$
    \hat{\boldsymbol{\beta}} = \argmin_{\boldsymbol{\beta}\in\mathbb{R}^{p+1}}{\left\{D(\boldsymbol{\beta}, \boldsymbol{y}) + \lambda \sum_{j=1}^p{|\beta_j|} \right\}}
    $$
    con
    \begin{itemize}
...
\begin{figure}
  ...
  % \begin{subfigure}[b]{5.9cm}
    \captionsetup{justification=raggedright}
    \centering
    \caption{\hspace{0.9cm} Distribuzione intermedia \\ \hspace{0.9cm} $\Rightarrow$ Elastic Net}
...
\uncover<1->{
  \begin{column}{0.5\linewidth}
    \begin{block}{Altre distribuzioni a priori\vphantom{/}}
      \begin{itemize}
...
\uncover<2->{
  \begin{column}{0.5\linewidth}
    \begin{block}{Vantaggi stimatori Bayesiani\vphantom{/}}
      \begin{itemize}
        \setlength\itemsep{0.2cm}
        % \setlength\topsep{0.2cm}
        ...
        \item Rimpiazzamento degli offset \\
          ...
          \begin{itemize}
            ...
            % \setlength\topsep{1cm}
            \fontsize{9pt}{11pt}\selectfont
            \item[\faCaretRight] Ho accortezza di quanto è forte la correzione applicata
...
\uncover<1->{
  \begin{column}{0.5\linewidth}
    \begin{block}{Modelli di Machine Learning\vphantom{/}}
      \begin{itemize}
...
\uncover<2->{
  \begin{column}{0.5\linewidth}
    \begin{block}{Caratteristiche\vphantom{/}}
      \begin{itemize}
...
\begin{table}[!h]
  ...
  \begin{tabular}{lccc}
    ...
    \textbf{} & \textbf{\makecell[c]{GLM \\ Classici}} & \textbf{GBM/RF/NN} & \textbf{\makecell[c]{GLM \\ Advancements}}\\
    \midrule[\heavyrulewidth]
    \cellcolor{gray!6}{Interpretabilità}                 & \cellcolor{gray!6}{\mystar\mystar\mystar}   &
      \cellcolor{gray!6}{\mystar\mystarO\mystarO} & \cellcolor{gray!6}{\mystar\mystar\mystar} \\
    Controllo delle variabili                            & \mystar\mystar\mystar                       &
      \mystar\mystarO\mystarO                     & \mystar\mystar\mystar  \\
    \cellcolor{gray!6}{Utilizzo di informazioni esterne} & \cellcolor{gray!6}{\mystar\mystar\mystarO}  &
      \cellcolor{gray!6}{\mystar\mystarO\mystarO} & \cellcolor{gray!6}{\mystar\mystar\mystar} \\
    Automazione e scalabilità                            & \mystar\mystarO\mystarO                     &
      \mystar\mystar\mystar                       & \mystar\mystar\mystarO \\
    \cellcolor{gray!6}{Flessibilità}                     & \cellcolor{gray!6}{\mystar\mystarO\mystarO} &
      \cellcolor{gray!6}{\mystar\mystar\mystar}   & \cellcolor{gray!6}{\mystar\mystar\mystarO} \\
    \bottomrule
  \end{tabular}
\end{table}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{L'importanza del Controllo delle Variabili nel Pricing}

% \fontsize{9pt}{11pt}\selectfont

%     \begin{block}{Figura dell'attuario}
%       \vspace{0.5cm}
%       \fontsize{8pt}{9pt}\selectfont
%       Secondo l'\textit{International Actuarial Association} (IAA), l'attuario deve avere:
%       \begin{itemize}
%         \item Competenze Analitiche
%         \item Conoscenza del Business
%         \item Comprensione del Comportamento Umano
%       \end{itemize}
%       % \vspace{0.1cm}
%       % \begin{myitemize}
%       %   \myitem{Competenze Analitiche}
%       %   \myitem{Conoscenza del Business}
%       %   \myitem{Comprensione del Comportamento Umano}
%       % \end{myitemize}
%     \end{block}
...
\uncover<1->{
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{block}{Il pricing si basa su}
        \begin{itemize}
          % \fontsize{9pt}{11pt}\selectfont
          % \fontsize{8pt}{9pt}\selectfont
          \item Osservazioni sul portafoglio passato
          \item Assunzioni sul portafoglio futuro
        \end{itemize}
      \end{block}
    \end{column}      
  \end{columns}
...
\uncover<2->{
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{block}{Necessità tecniche \\ per il controllo delle variabili\vphantom{/}}
        % \textbf{Necessità tecniche} \\
        % \fontsize{8pt}{9pt}\selectfont
        % \vspace{0.1cm}
        % \vspace{0.1cm}
        % Possibili problemi:
        \begin{itemize}
          % \fontsize{9pt}{11pt}\selectfont
          % \fontsize{8pt}{9pt}\selectfont
          \item Dati non rappresentativi del portafoglio futuro
          \item Stime con alta varianza su certi cluster
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{block}{Necessità commerciali \\ per il controllo delle variabili\vphantom{/}}
        % \textbf{Necessità commerciali}
        % \fontsize{7pt}{8pt}\selectfont
        \begin{itemize}
          % \fontsize{9pt}{11pt}\selectfont
          % \fontsize{8pt}{9pt}\selectfont
          \item Vincoli normativi
          \item Pricing opzioni
          \item Aspettative del cliente
          \item Strategia di business
        \end{itemize}
      \end{block}
    \end{column}
...
\begin{center}
  \begin{minipage}{7cm}
    \begin{varblock}[7cm]{Origine del Dataset}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Elastic Net: Tuning degli Iperparametri}

\begin{figure}
  \centering
  \includegraphics[width=10cm]{_bookdown_files/_main_files/figure-latex/en-tot-hp-tuning-plot-1.pdf}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Possibili Sviluppi}

% \fontsize{9pt}{11pt}\selectfont

\begin{center}
  \begin{minipage}{10cm}
    \begin{varblock}[10cm]{}%{Possibili Sviluppi}
      \begin{itemize}
        \item Utilizzare diverse distribuzioni a priori per i diversi $\beta_j$
        \item Considerare interazioni
        \item Ulteriore esplorazione sui GAM
        \item Modelli geografici
        \item Implementare i modelli su dataset più grandi con adeguate implementazioni informatiche
      \end{itemize}
    \end{varblock}
  \end{minipage}
\end{center}
...
\begin{center}
  \textcolor{myred}{\Huge \textbf{Backup}}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Elastic Net AIC: Tuning degli Iperparametri}

\begin{figure}
  \centering
  \includegraphics[width=10cm]{_bookdown_files/_main_files/figure-latex/en-aic-hp-tuning-plot-1.pdf}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=10cm]{_bookdown_files/_main_files/figure-latex/gbm-tot-hp-tuning-plot-1.pdf}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Confronto tra i coefficienti}

\begin{figure}
  \centering
  \includegraphics[width=11cm]{_bookdown_files/_main_files/figure-latex/coeff-pairs-1.pdf}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Confronto tra i coefficienti: outlier}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{Coefficienti azzerati}
