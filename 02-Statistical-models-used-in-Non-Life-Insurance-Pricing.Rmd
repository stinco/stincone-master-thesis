...
In this section we are going to compare the models we have seen in the previous sections making a specific focus on pricing needs. In subsection \@ref(chap:ml-techniques) we will also give some hints on _Machine Learning Algorithms_. These hints will be useful for some comments of the model described in this thesis.
