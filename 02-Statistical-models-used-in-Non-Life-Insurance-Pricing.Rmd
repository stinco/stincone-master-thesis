...
Another usual basis is th _B-spline_ basis. B-splines are functions defined recursively as follows.
...
In figure \@ref(fig:b-splines-plot) B-splines are represented. 
...
B-splines are preferred compared to truncated polynomial as they are less correlated and leads to more stable and less computationally expensive estimates.
