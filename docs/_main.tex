...
The figure \ref{fig:en-tot-hp-tuning-plot} shows the Cross Validation Deviance for the different sets of hyperparameters. As we can see, for each value of \(\alpha\) the points draw a curve that starts high, decreases and, after an elbow, increases again. The light blue vertical line corresponds to the optimal point that has hyperparameters \(\alpha = 0.06\) and
\(\lambda = 0.0002009233\).
...
With only the variables obtained with the stepwise selection, we fitted an Elastic Net. The figure \ref{fig:en-aic-hp-tuning-plot} shows the Cross Validation Deviance for the different sets of hyperparameters. The red veritical line corresponds to the optimal point that has hyperparameters \(\alpha = 0\) and
\(\lambda = 0.00001629751\).
