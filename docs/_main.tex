...
This result says that \(Z\) can be considered as the \emph{claim severity for a claim under the hypothesis that that claim occurred}. The demonstration of the equation \eqref{eq:z} is reported in the appendix in section \ref{chap:notes-on-compound-distribution}.
...
\hypertarget{chap:notes-on-compound-distribution}{%
\section{Notes on Compound distribution}\label{chap:notes-on-compound-distribution}}

In section \ref{chap:nlip-details} \ldots{}
