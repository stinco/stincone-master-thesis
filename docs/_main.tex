...
What is done in GAM to contain this wigglyness and to prevent overfitting is to take into account a penalization for wigglyness. This can be achieved by considering the minimization problem in \eqref{eq:max-lik-est-deviance} and adding a penalization term to the deviance:
\begin{equation}
