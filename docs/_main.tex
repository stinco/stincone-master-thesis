...
In this thesis we will describe some of the advancement of the statistical techniques commonly adopted in \emph{Non-Life Insurance Pricing} and we will discuss how they can satisfy the pricing specific needs.
...
Due to the intrinsic characteristics of the topic, in this thesis we will keep a multidisciplinary approach. We won't just compared the models from a statistical point of view, but we will also take important actuarial considerations, touching aspects from various subjects, such as law, economics, finance, risk management and marketing.
In our dissertation, we will also make a specific focus on data science, as in the last years the technological development and the growing availability of data made advanced analytics integral parts of actuarial science.
By discussing the solutions proposed we have also to comment some implementation issues from a computer science perspective.

All these aspects underline that the actuary, to carry out his profession, needs a wide range of skills that goes from the most technical one, such as understanding the statistical models or being able to conduct risk management evaluations, to the more business oriented ones, such as understanding the market characteristics and the customer behavior.

This thesis is organized into 3 parts:

\begin{itemize}[itemsep=2pt]
\item In chapter \ref{chap:nlip} we will describe in general how the non-life insurance pricing works starting from the definition of insurance contract, developing the discussion around technical pricing and taking into considerations price optimization;
