...
In our dissertation, we also made a specific focus on data science as, in the last years, the technological development and the growing availability of data made data science and advanced analytics integral parts of actuarial science. Talking about data science techniques we can't preclude us from taking some considerations on the implementation of the solutions we are proposing from a computer science perspective.
...
\item In chapter \ref{chap:nlip} we will describe in general how the non-life insurance pricing works starting from the definition of insurance contract, developing the discussion around technical pricing and taking some considerations on price optimization;
