...
\item
  if \(\lambda>1\), the mode is in a value greater than \(0\) and, as \(\lambda\) increases, the distribution assume a bell shape similar to the Normal distribution one. This can be obtained with the \emph{Central Limit Theorem}.
\end{itemize}
