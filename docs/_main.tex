...
\subsubsection{Cubic splines}\label{cubic-splines}}
...
\label{def:cubic-splines} \iffalse (Cubic Splines) \fi{} Given \(m\) real numbers \(\nu_1, \nu_2, \dots, \nu_m\), called \textit{knots}, and given a function \(f:[\nu_1, \nu_m] \to \mathbb{R}\) such that:
\[
