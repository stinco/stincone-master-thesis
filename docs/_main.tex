...
\subsubsection{\texorpdfstring{\ac{gam} extensions}{ extensions}}\label{extensions}}
...
\subsubsection{\texorpdfstring{\ac{lasso} Regression}{ Regression}}\label{regression}}
...
\subsubsection{\texorpdfstring{Ridge and \ac{lasso} Regression as Bayesian estimators for \ac{glm}}{Ridge and  Regression as Bayesian estimators for }}\label{chap:bayes-ridge-lasso}}
...
Considering the computation time, even if our data fits into the primary memory, if we want to run a complex algorithm with our processor, it could be infeasible in a reasonable amount of time. Indeed, the speed on a single \ac{cpu} is limited by physical constraints.
