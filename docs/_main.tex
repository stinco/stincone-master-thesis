...
\midrule
\em{\cellcolor{gray!6}{Information on the insured vehicle}} & \cellcolor{gray!6}{18}\\
\em{General information of the policyholder} & 36\\
\em{\cellcolor{gray!6}{Insurance specific information of the policyholder}} & \cellcolor{gray!6}{52}\\
\em{Policy options} & 13\\
\em{\cellcolor{gray!6}{Customer information on the policyholder}} & \cellcolor{gray!6}{5}\\
\em{Telematic data} & 7\\
\midrule
\em{\textbf{\cellcolor{gray!6}{Total}}} & \textbf{\cellcolor{gray!6}{131}}\\
\bottomrule
\end{tabular}
\end{table}
...
Anyway, as described in H2O documentation, ``GAM models are currently experimental''. We had some trials with GAMs on H2O, but, when we are writing, there are still many bugs and many functions for the hyperparameter tuning are not available yet. For this reason, for the GAM model we used the function \texttt{gam()} from the package \texttt{mgcv}.
