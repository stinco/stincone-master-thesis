...
In section \ref{chap:cubic-splines} we said that natural cubic splines on knots \(\nu_1, \dots, \nu_m\) contitute a \(m\)-dimensional vectorial space and that a possible basis decomposition is \eqref{eq:cubic-spline-decomposition}.

Another usual basis is th \emph{B-spline} basis. B-splines are functions defined recursively as follows.
