...
If we want to consider a more complex interaction between two quantitative variables with non-linear effect, GAM can be extended by considering consider non-parametrical interactions and modeling them with two-dimensional splines, such as:
\[
f(x_{l_1}, x_{l_2})
\]
...
\hypertarget{considerations-of-models}{%
\section{Considerations of models}\label{considerations-of-models}}
